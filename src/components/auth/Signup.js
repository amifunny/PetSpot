...
class Signup extends Component {
  ...
  render() {
    ...
    return (
      <Row className='py-5 justify-content-md-center margin'>
        <Col md={4} className='d-flex flex-column'>
          <div className='card'>
            <div className='card-body'>
              <img className='logo' src={logo} alt='petspot' />
              <p className='info'>
                Sign up to see photos of cute and cuddly pets
              </p>
              <form onSubmit={this.onSubmit}>
                <div className='form-group'>
                  <input
                    type='text'
                    className={classnames("form-input form-control form-control-lg", {
